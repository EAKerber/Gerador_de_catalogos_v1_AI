...
- no contexto editável, o rótulo de um filho direto aparece sob `hover` ou foco
  interno;
...
- Chromium em `1366×768` cobre rodapé composto, autoridade de contexto,
  revelação local, ausência de interseção entre rótulos e projeção de impressão;
