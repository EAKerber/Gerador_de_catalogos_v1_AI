...
| --- | --- | --- | --- | --- |
| 1 | P0 · concluído 05.52 | Fixture do ensaio real | Entrada, instruções, pacotes, PDFs, previews e alvos autorais inicial/revisado foram preservados numa fixture com hashes e atribuição de achados entre agente, kit, compilador, editor e asset. | Cumprido: os dois pacotes são reimportados pelo runtime real, seus arquivos internos são verificados e o caso pode ser comparado sem reconstrução manual. |
...
| 5 | P1 · concluído 05.51 | Ergonomia de `specification` | Escala do ícone, `gap` e `padding` agora possuem preset Automático/Compacto/Padrão/Confortável e ajustes discretos; Personalizado é derivado sem aceitar CSS livre. | Cumprido: normalização e ajustes preservam frame externo, lote atômico, undo/redo, importação, schema 1.16.0 e PDF. |
| 6 | P1 · concluído 05.53 | Cabeçalhos de tabela | Rótulo, ordem e visibilidade agora ficam em **Conteúdo**; `key` e células permanecem estáveis, e a última coluna visível é protegida. | Cumprido: renomear, mover e ocultar projetam editor/PDF sem excluir valores ou legendas; round-trip preserva o resultado em `CatalogDocument 1.16.0`. |
| 7 | P1 · concluído 05.54 | Descoberta no Authoring Kit | `authoring-patterns.json` e os fluxos curados tornam salientes apresentação, `specification` versus `fact` versus legenda, escala interna, `slot.span` e edição de colunas sem criar prosa concorrente ao inventário. | Cumprido contratualmente: os caminhos possuem IDs, propriedades, valores, limites e testes para um agente em início frio encontrá-los sem o usuário precisar nomear a função escondida; o ensaio cego do item 9 continua medindo essa descoberta por outro agente. |
| 8 | P2 · concluído 05.54/05.59/05.59B | Fundo útil e enquadramento de imagens factuais | O fluxo de assets distingue derivação externa rastreável de enquadramento não destrutivo por instância; o produto factual não pode ser completado ou reinterpretado. | Cumprido: o ensaio causal mediu 1,88× no recorte externo e 1,86× no editor, diferença relativa de 0,68%, sem corte e com o original intacto. Canvas neutro melhora continuidade de fundo sem ampliar o produto. |
| 9 | P0 · concluído 05.55/05.60 | Guia visual do Authoring Kit | Complemento separado com mapa da interface, sete microtutoriais, cookbook, troubleshooting, exemplos executáveis e estudos de caso; o 05.60 fixa o documento importado como autoridade e o preview paralelo como diagnóstico. | Cumprido: ZIP autônomo reúne núcleo+guia com hashes; pacotes de catálogo preservam apenas o núcleo; nenhuma imagem vira golden baseline e as duas referências conhecidas permanecem evidências não normativas. |
| 10 | P0 | Gate de aceitação prática | Executar o caso com um agente em início frio e uma terceira referência inédita, usando somente o kit, fatos e assets; depois executar uma rodada de revisão com feedback equivalente ao usuário. | Pacote válido, importação e PDF continuam verdes; o agente materializa a intenção vertical, o editor permanece utilizável a 100% e os ajustes de especificação/tabela são encontrados sem orientação nominal. |
| 11 | P0 · concluído 05.57 | Integridade factual e footer declarativo | Remover defaults comerciais, introduzir receitas estruturais sem fatos, perguntar quando faltarem dados e corrigir validação de tabelas/galerias. | Cumprido: nenhum fato é materializado sem origem; placeholders pendentes bloqueiam publicação; footer, linhas comerciais e gates possuem estados determinísticos. |
| 12 | P0 · concluído 05.59 | Enquadramento mínimo por instância | Expor zoom e deslocamento sem alterar o asset, preservar foco, recortar pelo slot e manter tela/PDF, undo/redo, round-trip, galeria e runtime do kit equivalentes. | Cumprido: zoom 100–400%, offsets X/Y, preencher mantendo foco e redefinir enquadramento são propriedades/comandos do átomo `art`; o 05.59B confirmou equivalência ao recorte externo no caso controlado. |
| 13 | P0 · concluído 05.59B | Ensaio causal das quatro condições | Usar o mesmo asset, átomo, card, slot e frame para separar original, canvas neutro, recorte externo e enquadramento do editor; registrar tela, impressão, PDF, hashes, ocupação e fidelidade. | Cumprido: os quatro artefatos foram materializados; tela/impressão variaram no máximo 0,24 p.p.; a falha anterior foi atribuída predominantemente à autoria/descoberta do kit. Próximo recorte: Authoring Kit 1.7.2 antes do item 10. |
| 14 | P0 · concluído 05.60 | Authoring Kit 1.7.2 dirigido por evidência | Incorporar a ordem causal do 05.59B, autoridade do documento importado, derivados por uso, auditoria de defaults e resolução perguntar → pendência → omissão explícita. | Cumprido: orientação contextual sem percentual universal; preview paralelo não é entrega; defaults comerciais são inválidos por construção e produto, tabela e footer pendentes bloqueiam publicação. Próximo recorte: item 10. |
