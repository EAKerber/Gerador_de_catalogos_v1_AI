...
| 8 | P2 · concluído 05.54/05.59 | Fundo útil e enquadramento de imagens factuais | O fluxo de assets distingue derivação externa rastreável de enquadramento não destrutivo por instância; o produto factual não pode ser completado ou reinterpretado. | Cumprido: o padrão descreve derivações com novo asset, enquanto o editor preserva o original e aplica fit, foco, zoom e deslocamento somente no viewport da instância. |
