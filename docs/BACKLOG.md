...
| 9 | P0 · em validação 05.55 | Guia visual do Authoring Kit | Complemento separado com mapa da interface, sete microtutoriais, cookbook, troubleshooting, exemplos executáveis e estudos de caso; manifesto e índice ligam imagens aos contratos sem duplicá-las em cada pacote. | ZIP autônomo reúne núcleo+guia com hashes; pacotes de catálogo preservam apenas o núcleo; nenhuma imagem vira golden baseline e o catálogo técnico deixa de ser alvo cego. |
