...
| Oportunidade | Camadas pode virar o ponto comum entre navegação, seleção, ordem e diagnóstico, reduzindo deslocamento entre canvas e inspector. | Prototipar somente melhorias apoiadas por teste de tarefa; componente de sobreposição promocional continua discovery separada. |
