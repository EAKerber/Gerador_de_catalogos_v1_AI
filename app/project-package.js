(function () {
  ...
  const AUTHORING_KIT_VERSION = "1.5.6";
  ...
  function buildCapabilitiesManifest(document = null) {
    ...
    return {
      ...
      editor: { name: "Catálogo V1", increment: "05.16", schemaVersion: window.CATALOG_SCHEMA_VERSION || "1.16.0" },
  ...
  class ProjectPackageManager {
    ...
    async buildPackage(options = {}) {
      ...
      const manifest = {
        ...
        generator: { name: "Catálogo V1", increment: "05.16", schemaVersion: document.schemaVersion },
