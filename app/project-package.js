(function () {
  ...
  const AUTHORING_KIT_VERSION = "1.7.2";
  ...
  function buildCapabilitiesManifest(document = null) {
    ...
    let manifest = {
      ...
      editor: { name: "Catálogo V1", increment: "05.60", schemaVersion: window.CATALOG_SCHEMA_VERSION || "1.16.0" },
  ...
  class ProjectPackageManager {
    ...
    async buildPackage(options = {}) {
      ...
      const manifest = {
        ...
        generator: { name: "Catálogo V1", increment: "05.60", schemaVersion: document.schemaVersion },
