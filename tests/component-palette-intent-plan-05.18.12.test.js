...
assert(main.includes('file: "component-palette-intent-contract.js"') && main.includes("CatalogComponentPaletteIntentContract?.install()"), "O editor não carrega e instala o contrato da biblioteca.");
