...
assert(footer.children.length === 6 && footer.children.every(child => child.type === "footer-item"), "O rodapé deve nascer como coleção de moléculas editáveis.");
...
assert(footer.children.length === 7 && added.frame.width > 0, "O rodapé não aceitou um novo item no slot coletivo.");
...
assert(migratedFooter.children[0].props.title === "Loja antiga" && migratedFooter.children[5].props.title === "Página 9", "Os dados legados do rodapé foram perdidos.");
