...
assert(fs.readFileSync(path.join(root, "index.html"), "utf8").includes('src="app/fact-recipe-contract.js"'), "O editor não carrega o contrato fact estaticamente.");
assert(fs.readFileSync(path.join(root, "tools", "build-authoring-kit.js"), "utf8").includes('"fact-recipe-contract.js"'), "O build canônico não copia o contrato fact.");
