...
assert(governance.governanceFormat === "CatalogFeatureGovernance" && governance.editorIncrement === "05.16", "Formato ou incremento da governança inválido.");
...
console.log(`✓ Governança cobre ${capabilityIds.length} capacidades, quatro frentes congeladas e a autoridade local entregue.`);
