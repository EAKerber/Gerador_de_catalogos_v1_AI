...
(async () => {
  ...
  await page.waitForFunction(() => window.CatalogEditor && window.CatalogCalloutRecipeContract?.VERSION === "05.20.15" && window.CatalogSectionRecipes?.VERSION === "1.5.0");
  ...
  assert(recipeText.includes("Chamada de dica") && recipeText.includes("responsiva") && recipeText.includes("hierarquia"), `Descrição evoluída ausente: ${recipeText}.`);
