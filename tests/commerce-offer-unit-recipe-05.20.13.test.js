...
assert(buildSource.includes('"commerce-offer-unit"'), "Manifesto não inclui a unidade.");
assert(mainSource.includes('file: "commerce-offer-unit-recipe-contract.js"'), "Editor não carrega a unidade.");
