...
(async () => {
  ...
  assert(capabilities.editor.increment === "05.16" && capabilities.recipes.length === 5 && capabilities.capabilities.officialSectionRecipes, "O kit não publicou as receitas oficiais do 05.16.");
  ...
  console.log("✓ Pacote, hashes, assets, CatalogSource, gates e AuthoringKit 1.5.6 validados.");
})().catch(error => {
  console.error(error);
  process.exitCode = 1;
});
