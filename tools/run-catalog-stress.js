...
const outputRoot = path.resolve(valueFor("--output", process.env.CATALOG_STRESS_OUTPUT_DIR || "/tmp/catalog-stress-batch"));
const tests = {
...
function printPlan() {
  console.log("Batch de estresse do catálogo");
...
async function main() {
  ...
  const summary = {
    suite: "Catalog integration stress batch",
