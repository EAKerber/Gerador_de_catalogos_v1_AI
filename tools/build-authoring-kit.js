...
fs.writeFileSync(path.join(root, "app", "authoring-kit-files.js"), output);
  ...
  console.log(`✓ CatalogAuthoringKit 1.5.6 gerado com ${Object.keys(files).length} arquivos, ${capabilities.components.length} componentes, ${capabilities.recipes.length} receitas, ${featureGuide.entries.length} fluxos curados e ${capabilityIds.size} capacidades governadas.`);
